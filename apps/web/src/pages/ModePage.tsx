  ...
  return (
    <PageShell title="选择游戏模式">
      <section className="space-y-4">
        ...
        <button type="button" aria-label="组队游戏" onClick={() => setMessage('组队功能正在连接中')} className="flex w-full items-center gap-4 rounded-3xl bg-slate-950 p-5 text-left text-white shadow-lg transition hover:bg-slate-800">
