  ...
  return (
    <PageShell back={false}>
      <section className="flex flex-1 flex-col items-center justify-center gap-8 rounded-[2rem] bg-white px-6 py-10 shadow-xl">
        <button type="button" aria-label="设置" onClick={() => setError('设置功能将在下一阶段开放')} className="pressable absolute right-7 top-7 rounded-full p-2 text-slate-500 hover:bg-slate-100">
