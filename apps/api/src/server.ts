...
import { RoomCleanupService, RoomCleanupTask, startRoomCleanupTask } from './operations/room-cleanup.js';
...
startRoomCleanupTask(new RoomCleanupTask({
  cleanupService: new RoomCleanupService({ db: database.db }),
  realtimeHub,
}));
